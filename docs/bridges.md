...
- **1.5-Mechanical Bridge.pdf** — Discrete mechanical lattices, phonons, and PE operator correspondences.  
- **1.5-Quantum Bridge.pdf** — Canonical mapping for quantum observables (Tier-1 ↔ Tier-2 correspondences).
