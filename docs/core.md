...
**Files (in `/core`):**
- **1-Paradox Engine – Explanatory Overlay.pdf** — annotated ultra-equation and formal context.  
- **2-Paradox Engine Rosetta.pdf** — human-readable translation of core ideas (educational/introductory).
